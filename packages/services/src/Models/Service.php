...
namespace Bittacora\Services\Models;
...
{
    use HasFactory, SortableTrait, HasTranslations, Userstamps;
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->table = config('bpanel4-services.table_name');
    }
    ...
    /**
     * Realizamos una relación con este modelo para trabajar con subcategorías.
     */
