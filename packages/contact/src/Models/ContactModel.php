...
namespace Bittacora\Contact\Models;
...
class ContactModel extends Model
{
    ...
    protected $fillable = [
        'title','text', 'address', 'phone', 'email', 'latitude', 'longitude', 'zoom', 'mobile', 'fax',
        'slug', 'meta_title', 'meta_description', 'meta_keywords','created_at','updated_at'
    ];

    protected $translatable = [
        'title','text', 'slug', 'meta_title', 'meta_description', 'meta_keywords'
    ];
    ...
    {
        $retorno = SlugOptions::createWithLocales([$this->getLocale()])
