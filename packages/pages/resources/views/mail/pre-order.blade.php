...
<div class="body-mail">
    <div class="body-mail__header">
        <img src="{{asset('assets/image/logo.webp')}}" alt="Partyfoods" width="200">
    </div>
    <div class="body-mail__content">
        <p>
            Un usuario quiere realizar una pre-orden de pedido a través de la página web de Partyfoods.
