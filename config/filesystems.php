...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'video' => [
            'driver' => 'local',
            'root' => storage_path('app/public/media/video'),
            'url' => env('APP_URL') . '/storage/media/video',
            'visibility' => 'public',
        ],
        'audio' => [
            'driver' => 'local',
            'root' => storage_path('app/public/media/audio'),
            'url' => env('APP_URL') . '/storage/media/audio',
            'visibility' => 'public',
        ],
        // ~@bp4MultimediaEnd@~
