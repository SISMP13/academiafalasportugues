...
@section('metaFields')
    ...
    'socialImage' => isset($model->images['Imagen social'][0])
    ? $model->images['Imagen social'][0]
    : ($generalConfiguration->images['Imagen social'][0] ?? null)
...
@section('content')
    @isset($model->images['Portada en ficha de servicio'][0])
        <div class="breadcrumb-wrapper"
             style="background-image: url({{$model->images['Portada en ficha de servicio'][0]->mediaModel->getUrl()}})">
            <div class="container">
    ...
    <div class="regular-page default-page">
        <div class="container-custom2">
            <div class="clearfix mt-5">
                @isset($model->images['Portada en ficha de servicio'][0]) @else
    ...
    @isset($model->images['Galería'][0])
        ...
        <div class="section bg-transparent position-relative border-0 z-index-1 m-0 p-0">
            <div class="container-custom2 py-4">
                <h2 class="color-primary text-center mb-4">{{__("Image gallery")}}</h2>
                {{--            seccion galeria--}}
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-md-5 mb-3">
                            <div class="zoom-gallery text-center">
                                <a href="{{ $image->mediaModel->getUrl() }}" data-fancybox="gallery">
                                    <img src="{{ $image->mediaModel->getUrl('gallery') }}" class="img-fluid"
                                         alt="{{$model->title}}">
                                </a>
                            </div>
                        </div>
