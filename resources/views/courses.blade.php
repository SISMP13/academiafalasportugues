            ...
            @else
                                        ...
                                        <div class="td_card td_style_1 td_radius_5">
                                            ...
                                            <a href="{{ route('course.details', $course->slug) }}"
                                               class="td_card_thumb td_mb_30 d-block">
                                                @if(isset($course->images["Imagen destacada"][0]))
                                                    <img src="{{ $course->images["Imagen destacada"][0] }}"
                                                         alt="{{ $course->title }}">
                                                @else
                                                    <img src="{{ asset('assets/image/web/2.jpeg') }}"
                                                         alt="{{ $course->title }}">
                                                @endif
                                                <i class="fa-solid fa-arrow-up-right-from-square"></i>

                                                {{-- Aquí podrías mostrar lugar/ubicación si existe --}}
                                                @if($course->location ?? false)
                                                    <span class="td_card_location td_medium td_white_color td_fs_18">
                                <svg width="16" height="22" ...></svg>
                                {{ $course->location }}
                            </span>
                                                @endif
                                            </a>
                ...
                <div class="container">
                    <div class="row td_gap_y_30">
                        <div class="col-lg-6">
                            <div class="td_card td_style_1 td_radius_5">
                                <a href="/" class="td_card_thumb td_mb_30 d-block">
                                    <img src="{{ asset('assets/template/img/home_1/event_thumb_1.jpg') }}"
                                         alt="Evento 1">
                                    <i class="fa-solid fa-arrow-up-right-from-square"></i>
                                    <span class="td_card_location td_medium td_white_color td_fs_18">
                  ...
                  Tsc Center, Northern Asia
                                ...
                                <div class="td_card_info">
                                    <div class="td_card_info_in">
                                        ...
                                        <h2 class="td_card_title td_fs_32 td_semibold td_mb_20">
                                            <a href="/">Innovate 2024: BBA Admission Conference</a>
                                        </h2>
                                        <p class="td_mb_30 td_fs_18">Education is a dynamic and evolving field that
                                            plays a
                                            crucial role in shaping individuals and societies. While there are
                                            significant
                                            challenges, </p>
