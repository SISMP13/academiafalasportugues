...
<div class="body-mail">
    ...
    <div class="body-mail__content">
        <p>
            Un usuario se ha inscrito a un curso a través de la página web {{config('app.name')}}.
            Los datos de la inscripción son los siguientes:
        </p>
        <ul class="body-mail__listado-datos">
            <li>
                <strong>Curso: </strong> {{ optional($inscription->course)->getTranslation('title', app()->getLocale(), true) ?? '—' }}
            </li>
            <li>
                <strong>Nombre: </strong> {{ $inscription->name }}
            </li>
            <li>
                <strong>Email: </strong> {{ $inscription->email }}
            </li>
            @if(!empty($inscription->phone))
                <li>
                    <strong>Teléfono: </strong> {{ $inscription->phone }}
                </li>
            @endif
            @if(!empty($inscription->message))
                <li>
                    <strong>Mensaje: </strong> {{ $inscription->message }}
                </li>
            @endif
        </ul>
    </div>
